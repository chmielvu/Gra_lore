...
export const ForgeIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M9.13 14.88c-.6-1.09-.31-2.48.6-3.32l.41-.38c.9-.83 1.2-2.04.79-3.1L9.67 6.4a2.2 2.2 0 0 0-3.3 1.1l-1.2 3.4a2.2 2.2 0 0 0 1.1 3.3l3.4 1.2c1.1.4 2.31.1 3.1-.8z" />
        <path d="M4.6 15.36c-1.1.4-1.32 1.73-.39 2.66l.33.33c.93.93 2.26.71 2.66-.39l1.2-3.4a2.2 2.2 0 0 0-3.3-1.1l-1.7 1.5z" />
        <path d="m15 6-1 2-4 4 2 1 4-4 1-2" />
        <path d="m18 9 2 1" />
        <path d="m21.36 12.36-.33-.33c-.93-.93-.71-2.26.39-2.66l3.4-1.2a2.2 2.2 0 0 1 3.3 1.1l1.2 3.4a2.2 2.2 0 0 1-1.1 3.3l-3.4 1.2c-1.1.4-2.31.1-3.1-.8z" />
    </svg>
);
...
export const Wand2Icon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M11 3a2 2 0 0 0-2 2v5h5a2 2 0 0 0 2-2V5a2 2 0 0 0-2-2z"/><path d="m21 12-2 2-2-2"/><path d="m3 12 2 2 2-2"/><path d="M12 21a9 9 0 0 0 9-9"/><path d="M12 21a9 9 0 0 1-9-9"/></svg>
);

export const MapIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M14.106 14.106a2 2 0 1 1-2.828-2.828 2 2 0 0 1 2.828 2.828z"/><path d="M18.828 18.828a10 10 0 1 1-13.656-13.656 10 10 0 0 1 13.656 13.656z"/><path d="M21 21-6-6"/></svg>
);
...
export const CommitIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
